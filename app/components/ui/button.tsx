...
const buttonVariants = cva(
  ...
  dark:aria-invalid:ring-destructive/40`,
  {
    variants: {
      variant: {
        default: `border border-foreground bg-primary text-primary-foreground
        shadow-xs inset-shadow-2xs inset-shadow-neutral-600 before:absolute
        before:inset-0 before:bg-linear-to-b before:from-white/20
        before:to-transparent hover:bg-primary/90`,
        ...
        secondary: `border border-neutral-300 bg-secondary
        text-secondary-foreground shadow-xs inset-shadow-2xs inset-shadow-white
        before:absolute before:inset-0 before:bg-linear-to-b
        before:from-background/20 before:to-transparent hover:bg-secondary/80`,
        ghost:
