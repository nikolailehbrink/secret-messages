  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        border-input bg-background px-3 py-2 text-sm font-normal
        ...
        data-[placeholder]:text-muted-foreground/75 data-[size=default]:h-10
        data-[size=sm]:h-9 *:data-[slot=select-value]:line-clamp-1
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        ...
        py-1.5 pr-8 pl-2 text-sm outline-hidden select-none focus:bg-accent
        focus:text-accent-foreground data-[disabled]:pointer-events-none
        data-[disabled]:opacity-50 *:[span]:last:flex *:[span]:last:items-center
        *:[span]:last:gap-2`,
        className,
      )}
      {...props}
